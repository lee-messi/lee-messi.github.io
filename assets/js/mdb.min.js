          ...
          (() => {
            ...
            function i(t) {
              t.hasAttribute("autocompleted") &&
                ...
                t.dispatchEvent(new window.CustomEvent("onautocomplete", { bubbles: !0, cancelable: !1, detail: null })));
            }
                  ...
                  ? ((h = i),
                    ...
                    function e(n) {
                      ...
                      for (let t = n["target"]; t && t !== this; t = t.parentNode)
                        for (const o of i) if (o === t) return Nt(n, { delegateTarget: t }), e.oneOff && Pt.off(h, n.type, d, f), f.apply(t, [n]);
                    })
                  : ((l = i),
                    (u = e),
                    function t(e) {
            ...
            if (!this._isSliding) {
              ...
              if (o !== i) {
                const r = this._getItemIndex(o),
                  s = (t) =>
                    f.trigger(this._element, t, { relatedTarget: o, direction: this._orderToDirection(e), from: this._getItemIndex(i), to: r });
                t = s(tn);
        ...
        var xi = {
          ...
          fn: function (t) {
            ...
            a &&
              ...
              (n = r),
              (n = wi(
                "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, n.rects, { placement: n.placement })) : t) ? t : Ei(t, Hn)
              )),
              (t = di(a)),
              (o = "y" === l ? O : I),
              (i = "y" === l ? L : S),
            ...
            fn: function (t) {
              ...
              null != e.modifiersData.popperOffsets &&
                (e.styles.popper = Object.assign(
                  {},
                  e.styles.popper,
                  Ti(Object.assign({}, n, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: i, roundOffsets: t }))
                )),
                null != e.modifiersData.arrow &&
                  (e.styles.arrow = Object.assign(
                    {},
                    e.styles.arrow,
                    Ti(Object.assign({}, n, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: t }))
                  )),
                  ...
                  a = [s].concat(n).reduce(function (t, e) {
                    return t.concat(
                      k(e) === Rn
                        ? ((n = h),
                          (i = (t = t =
                            void 0 === (t = { placement: e, boundary: f, rootBoundary: p, padding: d, flipVariations: g, allowedAutoPlacements: m })
                              ? {}
                              : t).placement),
                          (o = t.boundary),
                          (r = t.rootBoundary),
                  ...
                  return (
                    ...
                    s.orderedModifiers.forEach(function (t) {
                      var e = t.name,
                        ...
                        t = t.effect;
                      "function" == typeof t &&
                        ((t = t({ state: s, name: e, instance: l, options: void 0 === n ? {} : n })), a.push(t || function () {}));
                    }),
                    l.update()
                  );
                },
                      ...
                      for (var n, i, o, r = 0; r < s.orderedModifiers.length; r++)
                        !0 === s.reset
                          ...
                          : ((n = (o = s.orderedModifiers[r]).fn),
                            (i = o.options),
                            (o = o.name),
                            "function" == typeof n && (s = n({ state: s, options: void 0 === i ? {} : i, name: o, instance: l }) || s));
                    }
                  }
                },
                update:
        ...
        class ta {
          ...
          _autoInit(e) {
            ...
            this._element.style.minWidth ||
              (c.style(this._element, { "min-width": "".concat(getComputedStyle(this._element).width) }), (this._isMinWidthSet = !0)),
